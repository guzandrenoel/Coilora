...
`apps/web`, `apps/api`, `supabase`, and the documentation exist today. Worker,
shared-package, service, deployment, and native-client directories are created only when
